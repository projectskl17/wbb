...
home_keyboard_pm = InlineKeyboardMarkup(
    [
        ...
        [
            ...
            InlineKeyboardButton(
                text="Support 👨", url="http://t.me/Protoctomax"
            ),
        ],
        [
            InlineKeyboardButton(
...
keyboard = InlineKeyboardMarkup(
    [
        ...
        [
            ...
            InlineKeyboardButton(text="Support 👨", url="t.me/Protoctomax"),
        ],
    ]
)
    ...
    if message.chat.type != ChatType.PRIVATE:
        ...
        if len(message.command) >= 2:
            ...
            if str(name) in HELPABLE:
                ...
                await message.reply(text, link_preview_options={"is_disabled": True})
            else:
            ...
            await message.reply(
                text, reply_markup=help_keyboard, link_preview_options={"is_disabled": True}
            )
    return
